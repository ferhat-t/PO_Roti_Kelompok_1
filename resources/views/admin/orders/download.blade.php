...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .company-name { font-size: 28px; font-weight: bold; color: #ff6b35; margin-bottom: 5px; }
        ...
        .info-section h3 { color: #ff6b35; font-size: 16px; margin-bottom: 10px; border-bottom: 2px solid #ff6b35; padding-bottom: 5px; }
        ...
        .total-row td { border-top: 3px solid #ff6b35; }
...
<body>
    ...
    <div class="info-box">
        ...
        <div class="info-section">
            ...
            <div class="info-row">
                ...
                <div class="info-value" style="text-transform: uppercase; font-weight: bold; color: #ff6b35;">
                    {{ $order->status }}
                </div>
            </div>
        </div>
    ...
    <!-- Order Items Table -->
    <h3 style="color: #ff6b35; margin-bottom: 10px;">🛒 Item Pesanan</h3>
    <table>
        <thead>
            <tr>
        ...
        <tfoot>
            <tr class="total-row">
                ...
                <td class="text-right" style="font-size: 18px; color: #ff6b35;">
    ...
    <!-- Footer -->
    <div class="footer">
        <p><strong>Terima kasih atas kepercayaan Anda berbelanja di needroTI!</strong></p>
        <p>Website: www.needroti.com | Email: info@needroti.com</p>
        <p>Dokumen ini digenerate otomatis pada {{ now()->format('d F Y, H:i') }} WIB</p>
    </div>
</body>
</html>